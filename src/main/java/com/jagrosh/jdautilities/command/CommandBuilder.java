...
public class CommandBuilder
{
    ...
    /**
     * Sets the name of a {@link com.jagrosh.jdautilities.command.Command#requiredRoles
     ...
     * @return This CommandBuilder
     */
    public CommandBuilder setRequiredRole(List<String> requiredRoles)
    {
    ...
    public Command build(BiConsumer<Command,CommandEvent> execution)
    {
        return new BlankCommand(name, help, category, arguments,
                guildOnly, requiredRoles, ownerCommand, cooldown,
    ...
    private abstract class BlankCommand extends Command
    {
        BlankCommand(String name, String help, Category category,
                     String arguments, boolean guildOnly, List<String> requiredRoles,
